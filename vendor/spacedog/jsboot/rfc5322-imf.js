...
(function() {
  ...
  var obsQp = '\\\\' + this.ABNF.makeClass('\\x00' + obsNOWSCTL + this.ABNF.LF + this.ABNF.CR);
  ...
  var newQp = '\\\\' + this.ABNF.makeClass(this.ABNF.VCHAR + this.ABNF.WSP);

  var quotedPair = this.ABNF.alternate(newQp, obsQp);
  ...
  var ccontent = this.ABNF.alternate(ctext, quotedPair);

  var comment = '\\(' + this.ABNF.repeat(this.ABNF.optional(FWS) + ccontent) + this.ABNF.optional(FWS) + '\\)';

  ccontent = this.ABNF.alternate(ctext, quotedPair, comment);

  var CFWS = this.ABNF.alternate(this.ABNF.repeat(this.ABNF.optional(FWS) + comment, 1) + this.ABNF.optional(FWS), FWS);
  ...
  var qcontent = this.ABNF.alternate(qtext, quotedPair);
  var quotedString = this.ABNF.optional(CFWS) + this.ABNF.makeClass(this.ABNF.DQUOTE) +
    this.ABNF.repeat(this.ABNF.optional(FWS) + qcontent) + this.ABNF.optional(FWS) +
    this.ABNF.makeClass(this.ABNF.DQUOTE) + this.ABNF.optional(CFWS);
  ...
  var atext = this.ABNF.ALPHA + this.ABNF.DIGIT + '\\/=?^_`{|}~!#$%&\'*+-';
  var atom = this.ABNF.optional(CFWS) + this.ABNF.repeat(atext, 1) + this.ABNF.optional(CFWS);

  var dotAtomText = this.ABNF.repeat(atext, 1) + this.ABNF.repeat('[.]' + this.ABNF.repeat(atext, 1));
  var dotAtom = this.ABNF.optional(CFWS) + dotAtomText + this.ABNF.optional(CFWS);



  // Various tokens
  var word = this.ABNF.alternate(atom, quotedString);
  ...
  var obsDtext = this.ABNF.alternate(obsNOWSCTL, quotedPair);
  var obsDomain = atom + this.ABNF.repeat('[.]' + atom);
  var obsLocalPart = word + this.ABNF.repeat('[.]' + word);
  ...
  var dtext = this.ABNF.alternate('\\x21-\\x5a\\x5e-\\x7e', obsDtext);

  // XXX not proper - should conform to corresponding RFC (IRI prolly)
  var domainLiteral = this.ABNF.optional(CFWS) + '\\[' +
    this.ABNF.repeat(this.ABNF.optional(FWS) + dtext) +
    this.ABNF.optional(FWS) + '\\]' + this.ABNF.optional(CFWS);
   ...
   */
  this.DOMAIN = this.ABNF.alternate(dotAtom, domainLiteral, obsDomain);
   ...
   * @constant
   */
  this.LOCAL_PART = this.ABNF.alternate(dotAtom, quotedString, obsLocalPart);
