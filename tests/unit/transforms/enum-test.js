...
test('undefined is undefined', function(assert) {
  ...
  ['', 0, -0, false, null, NaN, -NaN, 'string', 1, 1.1, Infinity, -Infinity, true, function(){}, [], [1, '2'], {},
...
test('valid options', function(assert) {
  ...
  var opts = ['', 0, -0, false, null, 'string', 1, 1.1, Infinity, -Infinity, true, function(){}, [], [1, '2'], {},
    {foo: 'bar', 1: 2}, new Date(), new RegExp(), undefined, ];
